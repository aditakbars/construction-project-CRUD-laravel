...
<h4 class="mt-3">Data Vendor yang sudah terhapus</h4>
...
<form action="{{route('vendor.trash')}}" method="GET" class="mb-3 mt-1">
        ...
        <tr>
            ...
            <td>
                <button type="button" class="btn btn-info" data-bs-toggle="modal"
                    data-bs-target="#restoreModal{{ $data->id_vendor }}">Pulihkan</button>
                ...
                <!-- Modal -->
                <div class="modal fade" id="restoreModal{{ $data->id_vendor }}" tabindex="-1"
