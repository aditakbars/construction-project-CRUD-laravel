    ...
    <div class="col-md-12 grid-margin stretch-card">
        <div class="card">
            <div class="card-body">
                ...
                <h4 class="card-title mb-sm-0">Daftar Vendor</h4>
                <form action="{{route('vendor.index')}}" method="GET" class="mr-0 ml-auto mb-1 mb-sm-0">
                    <input type="text" name="search" class="form-control rounded-1 text-dark" placeholder="Cari Vendor..." value="{{$searchTerm}}">
                </form>
                <a href="{{route('vendor.create')}}" class="btn btn-lg btn-inverse-info p-2 mr-1 ml-3 mb-1 mb-sm-0"> Tambah Data Vendor</a>
                </div>
                    ...
                    <table class="table table-hover">
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td>{{ $data->jenis }}</td>
                                <td>
                                    <a href="{{ route('vendor.edit', $data->id_vendor) }}" class="btn btn-primary p-2">Edit</a>
                                    <button class="btn btn-danger p-2 ml-1" data-bs-toggle="modal" data-bs-target="#hapusModal{{ $data->id_vendor }}">Delete</button>
