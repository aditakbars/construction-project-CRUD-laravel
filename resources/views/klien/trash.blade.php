...
<form action="{{route('klien.trash')}}" method="GET" class="mb-3 mt-1">
        ...
        <tr>
            ...
            <td>
                <button type="button" class="btn btn-info" data-bs-toggle="modal"
                    data-bs-target="#restoreModal{{ $data->id_klien }}">Pulihkan</button>
                ...
                <!-- Modal -->
                <div class="modal fade" id="restoreModal{{ $data->id_klien }}" tabindex="-1"
