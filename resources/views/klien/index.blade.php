...
<h4 class="mt-3">Data Klien</h4>

<a href="{{ route('klien.create') }}" type="button" class="btn btn-primary rounded-3 mb-2">Tambah Data klien</a>
<a href="{{ route('klien.trash') }}" type="button" class="btn btn-warning rounded-3 mb-2">Data klien yang sudah dihapus</a>
